...
FEDPKG_LIBDRM_DIRECTORY=~/tempthing/fedpkg/libdrm
# https://gitlab.freedesktop.org/mesa/drm/-/tags/libdrm-2.4.120
LIBDRM_VERSION="2.4.120"
# https://src.fedoraproject.org/rpms/libdrm/tree/f40
FEDORA_DIST_VERSION="-3.fc40"
